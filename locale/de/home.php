...
$trans["indexCircDesc2"]     = "\$text='Mitglieder-Verwaltung (Neu, Suche, Bearbeiten, Loeschen)';";
$trans["indexCircDesc3"]     = "\$text='Ausleihe, Vorbestellungen, Gebuehrenverwaltung und History der Mitglieder';";
$trans["indexCircDesc4"]     = "\$text='Medienrueckgabe und Eingangsablage';";
...
$trans["indexCatDesc2"]      = "\$text='Medien-Verwaltung (Neu, Suche, Bearbeiten, Loeschen)';";
//$trans["indexCatDesc3"]      = "\$text='Import bibliography from USMarc record';";
$trans["indexAdmin"]         = "\$text='Admin';";
$trans["indexAdminDesc1"]    = "\$text='Benutzen Sie diesen Reiter um die Mitarbeiter zu verwalten und die Programmeinstellungen zu aendern.';";
$trans["indexAdminDesc2"]    = "\$text='Mitarbeiter Verwaltung (Neu, Bearbeiten, Passwort, Loeschen)';";
...
$trans["indexReportsDesc1"]  = "\$text='Benutzen Sie diesen Reiter um Berichte ueber die Daten zu erstellen.';";
