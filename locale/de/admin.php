...
#****************************************************************************
$trans["adminSubmit"]              = "\$text = '&Uuml;bermitteln';";
$trans["adminCancel"]              = "\$text = 'Abbrechen';";
$trans["adminDelete"]              = "\$text = 'L&ouml;schen';";
$trans["adminUpdate"]              = "\$text = 'Update';";
$trans["adminFootnote"]            = "\$text = 'Felder, die mit %symbol% markiert sind, werden ben&ouml;tigt.';";

#****************************************************************************
#*  Translation text for page index.php
#****************************************************************************
$trans["indexHdr"]                 = "\$text = 'Admin';";
$trans["indexDesc"]                = "\$text = 'Benutzen Sie die Funktionen im linken Navigationsbereich, um die Mitarbeiter anzulegen und zu bearbeiten und die Programmeinstellungen zu &auml;ndern.';";

#****************************************************************************
#*  Translation text for page collections*.php
#****************************************************************************
$trans["adminCollections_delReturn"]                 = "\$text = 'kehre zur Genreliste zur&uuml;ck';";
$trans["adminCollections_delStart"]                 = "\$text = 'Genre, ';";

#****************************************************************************
#*  Translation text for page collections_del.php
#****************************************************************************
$trans["adminCollections_delEnd"]                 = "\$text = ', wurde gel&ouml;scht.';";

#****************************************************************************
#*  Translation text for page collections_del_confirm.php
#****************************************************************************
$trans["adminCollections_del_confirmText"]                 = "\$text = 'Sind Sie sicher folgendes Genre zu l&ouml;schen: ';";
...
$trans["adminCollections_edit_formDailyLateFee"]                 = "\$text = 'T&auml;gliche Vers&auml;umnisgeb&uuml;hr:';";
...
#****************************************************************************
$trans["adminCollections_listAddNewCollection"]                 = "\$text = 'F&uuml;ge neues Genre hinzu';";
...
$trans["adminCollections_listDailylatefee"]                 = "\$text = 'T&auml;gliche<br>Vers&auml;umnisgeb&uuml;hr';";
$trans["adminCollections_listBibliographycount"]                 = "\$text = 'Anzahl der<br>Medien';";
$trans["adminCollections_listEdit"]                 = "\$text = 'Bearb.';";
$trans["adminCollections_listDel"]                 = "\$text = 'L&ouml;sche';";
$trans["adminCollections_ListNote"]                 = "\$text = '*Bemerkung:';";
$trans["adminCollections_ListNoteText"]                 = "\$text = 'Man kann nur Genres l&ouml;schen, die keine Medien enthalten.<br>Wenn Sie ein Genre l&ouml;schen m&ouml;chten, welches Medien enth&auml;lt, m&uuml;ssen sie diese Medien zuerst einem anderen Genre zuordnen.';";

#****************************************************************************
#*  Translation text for page collections_new.php
#****************************************************************************
$trans["adminCollections_newAdded"]                 = "\$text = ', wurde hinzugef&uuml;gt.';";

#****************************************************************************
#*  Translation text for page collections_new_form.php
#****************************************************************************
$trans["adminCollections_new_formAddnewcollection"]                 = "\$text = 'F&uuml;ge neues Genre hinzu:';";
...
$trans["adminCollections_new_formDailylatefee"]                 = "\$text = 'T&auml;gliche Vers&auml;umnisgeb&uuml;hr:';";
...
$trans["admin_materials_delMaterialdeleted"]                 = "\$text = ', wurde gel&ouml;scht.';";
$trans["admin_materials_Return"]                 = "\$text = 'kehre zur Medienartenliste zur&uuml;ck';";

#****************************************************************************
#*  Translation text for page materials_del_form.php
#****************************************************************************
$trans["admin_materials_delAreyousure"]                 = "\$text = 'Sind Sie sicher folgende Medienart zu l&ouml;schen: ';";
...
$trans["admin_materials_delunlimited"]                 = "\$text = '(0 f&uuml;r unbeschr&auml;nkt)';";
$trans["admin_materials_delImagefile"]                 = "\$text = 'Bilddatei:';";
$trans["admin_materials_delNote"]                 = "\$text = '*Bemerkung:';";
$trans["admin_materials_delNoteText"]                 = "\$text = 'Die Bilddatein muﬂ sich im Verzeichnis openbiblio/images befinden.';";
...
#****************************************************************************
$trans["admin_materials_listAddmaterialtypes"]                 = "\$text = 'F&uuml;ge neue Medienart hinzu';";
...
$trans["admin_materials_listRenewallimit"]                 = "\$text = 'Verl&auml;ngerung';";
...
$trans["admin_materials_listDel"]                 = "\$text = 'L&ouml;sche';";
$trans["admin_materials_listNote"]                 = "\$text = '*Bemerkung:';";
$trans["admin_materials_listNoteText"]                 = "\$text = 'Man kann nur Medienarten l&ouml;schen, die keine Medien enthalten.<br>Wenn Sie eine Medienart l&ouml;schen m&ouml;chten, welche Medien enth&auml;lt, m&uuml;ssen sie diese Medien zuerst einer anderen Medienart zuordnen.';";
$trans["No fields found!"]                 = "\$text = 'Keine Felder gefunden!';";

#****************************************************************************
#*  Translation text for page materials_new.php
#****************************************************************************
$trans["admin_materials_listNewadded"]                 = "\$text = ', wurde hinzugef&uuml;gt.';";

#****************************************************************************
#*  Translation text for page materials_new_form.php
#****************************************************************************
$trans["admin_materials_new_formNoteText"]                 = "\$text = 'Die Bilddatei muﬂ sich im Verzeichnis openbiblio/images befinden.';";
...
$trans["admin_settingsLibhours"]                 = "\$text = '&Ouml;ffnungszeiten:';";
...
$trans["admin_settingsPurgebibhistory"]                 = "\$text = 'L&ouml;sche vergangene Ausleihvorg&auml;nge nach:';";
$trans["admin_settingsmonths"]                 = "\$text = 'Monaten';";
$trans["admin_settingsBlockCheckouts"]                 = "\$text = 'Blockiere Ausleihe, wenn Geb&uuml;hren anstehen:';";
...
$trans["If the month value for purging history is higher than zero, values in statistics reports shift over time.<br>Data from statistics reports should be saved outside OpenBiblio for future reference."]                 = "\$text = 'Wenn die Monatsanzahl beim l&ouml;schen der Historie gr&ouml;ﬂer als Null ist, k&ouml;nnen sich die statistischen Werte ver&auml;ndern.<br>Daten aus statistischen Reporten sollten f&uuml;r zuk&uuml;nftige Referenzen auﬂerhalb von Openbiblio gespeichert werden.';";

#****************************************************************************
#*  Translation text for all staff pages
#****************************************************************************
$trans["adminStaff_Staffmember"]                 = "\$text = 'Mitarbeiter,';";
$trans["adminStaff_Return"]                 = "\$text = 'kehre zur Mitarbeiterliste zur&uuml;ck';";
...
#****************************************************************************
$trans["adminStaff_delDeleted"]                 = "\$text = ', wurde gel&ouml;scht.';";

#****************************************************************************
#*  Translation text for page staff_delete_confirm.php
#****************************************************************************
$trans["adminStaff_del_confirmConfirmText"]                 = "\$text = 'Sind Sie sicher folgenden Mitarbeiter zu l&ouml;schen: ';";
...
#****************************************************************************
$trans["adminStaff_list_formHeader"]                 = "\$text = 'F&uuml;ge neue Mitarbeiter hinzu';";
...
$trans["adminStaff_list_Del"]                 = "\$text = 'L&ouml;sche';";

#****************************************************************************
#*  Translation text for page staff_new.php
#****************************************************************************
$trans["adminStaff_new_Added"]                 = "\$text = ', wurde hinzugef&uuml;gt.';";

#****************************************************************************
#*  Translation text for page staff_new_form.php
#****************************************************************************
$trans["adminStaff_new_form_Header"]          	= "\$text = 'F&uuml;ge neuen Mitarbeiter hinzu:';";
...
#****************************************************************************
$trans["adminStaff_pwd_reset_Passwordreset"]   = "\$text = 'Passwort wurde ge&auml;ndert.';";

#****************************************************************************
#*  Translation text for page staff_pwd_reset_form.php
#****************************************************************************
$trans["adminStaff_pwd_reset_form_Resetheader"]   = "\$text = '&Auml;ndere Mitarbeiter Passwort:';";

#****************************************************************************
#*  Translation text for theme pages
#****************************************************************************
$trans["adminTheme_Return"]                 = "\$text = 'kehre zur Layoutliste zur&uuml;ck';";
$trans["adminTheme_Theme"]                 = "\$text = 'Layout, ';";

#****************************************************************************
#*  Translation text for page theme_del.php
#****************************************************************************
$trans["adminTheme_Deleted"]                 = "\$text = ', wurde gel&ouml;scht.';";
#****************************************************************************
#*  Translation text for page theme_del_confirm.php
#****************************************************************************
$trans["adminTheme_Deleteconfirm"]                 = "\$text = 'Sind Sie sicher folgendes Layout zu l&ouml;schen: ';";
#****************************************************************************
...
$trans["adminTheme_Choosetheme"]                 = "\$text = 'W&auml;hle ein neues Layout aus:';";
$trans["adminTheme_Addnew"]                 = "\$text = 'F&uuml;ge neues Layout hinzu';";
...
$trans["adminTheme_Del"]                 = "\$text = 'L&ouml;sche';";
$trans["adminTheme_Inuse"]                 = "\$text = 'benutzt';";
$trans["adminTheme_Note"]                 = "\$text = '*Bemerkung:';";
$trans["adminTheme_Notetext"]                 = "\$text = 'Layouts die gerade benutzt werden k&ouml;nnen nicht gel&ouml;scht werden.';";
...
$trans["adminTheme_Fontsize"]                 = "\$text = 'Schriftgr&ouml;ﬂe:';";
...
#****************************************************************************
$trans["adminTheme_new_Added"]                 = "\$text = ', wurde hinzugef&uuml;gt.';";
...
$trans["adminTheme_preview_CloseWindow"]                 = "\$text = 'Schlieﬂe Fenster';";
...
#****************************************************************************
$trans["Privileges updated"]               = "\$text = 'Einstellungen ge&auml;ndert';";
...
$trans["Renewal Limit:"]                   = "\$text = 'Verl&auml;ngerunsglimit:';";
$trans["Checkout Privileges"]              = "\$text = 'Ausleiheinstellungen';";
$trans["function"]                         = "\$text = 'Funktion';";
$trans["Material Type"]                    = "\$text = 'Medienart';";
$trans["Member Classification"]            = "\$text = 'Mitgliederart';";
$trans["Checkout Limit"]                   = "\$text = 'Ausleihlimit';";
$trans["Renewal Limit"]                    = "\$text = 'Verl&auml;ngerungslimit';";
...
$trans["Copy field, %desc%, has been deleted."] = "\$text = 'Exemplarfeld, %desc%, wurde gel&ouml;scht.';";
$trans["return to copy field list"]             = "\$text = 'Zur&uuml;ck zur Exemplarfeldliste';";
$trans["return to copy fields list"]             = "\$text = 'Zur&uuml;ck zur Exemplarfeldliste';";
$trans["Are you sure you want to delete field '%desc%'?"] = "\$text = 'Sind Sie sicher, dass sie das Feld \'%desc%\' l&ouml;schen wollen?';";
...
$trans["Add new custom field"]                  = "\$text = 'F&uuml;ge neues spezifisches Feld hinzu';";
$trans["Custom Copy Fields"]                    = "\$text = 'Spezifisches Exemplarfeld';";
$trans["function"]                              = "\$text = 'Funktion';";
$trans["Code"]                                  = "\$text = 'Kennzeichen';";
$trans["Description"]                           = "\$text = 'Beschreibung';";
$trans["del"]                                   = "\$text = 'L&ouml;schen';";
$trans["Copy field, %desc%, has been added."]   = "\$text = 'Exemplarfeld, %desc%, wurde hinzugef&uuml;gt.';";
$trans["Add custom copy field"]                 = "\$text = 'F&uuml;ge spezifisches Exemplarfeld hinzu';";

#****************************************************************************
#*  Translation text for Member Classify 
#****************************************************************************

$trans["Classification type, %desc%, has been deleted."] = "\$text = 'Mitgliederart, %desc%, wurde gel&ouml;scht.';";
$trans["return to member classification list"]           = "\$text = 'Zur&uuml;ck zur Liste der Mitgliederarten';";
$trans["Are you sure you want to delete classification '%desc%'?"] = "\$text = 'Sind Sie sicher die Mitgliederart \'%desc%\' zu l&ouml;schen?';";
...
$trans["Max. Fines:"]                                    = "\$text = 'Max. Geb&uuml;hren:';";
$trans["Add new member classification"]                  = "\$text = 'Neue Mitgliederart hinzuf&uuml;gen';";
$trans["Member Classifications List"]                    = "\$text = 'Liste der Mitgliederarten';";
$trans["Max. Fines"]                                     = "\$text = 'Max. Geb&uuml;hren';";
$trans["Members"]                                        = "\$text = 'Mitglieder';";
$trans["*Note:"]                                         = "\$text = '*Bemerkung:';";
$trans["The delete function is only available on classifications that have a member count of zero.  If you wish to delete a classification with a member count greater than zero you will first need to change those members to another classification."]     = "\$text = 'Die L&ouml;schfunktion ist nur verf&uuml;gbar, bei Mitgliederarten, die keine Mitglieder haben. Wenn Sie eine Mitgliederart l&ouml;schen m&ouml;chten, die mehr als Null Mitglieder haben, dann m&uuml;ssen Sie diese Mitglieder erst in eine andere Mitgliederart verschieben.';";
$trans["Classification type, %desc%, has been added."]   = "\$text = 'Mitgliederart, %desc%, wurde hinzugef&uuml;gt.';";
$trans["Add new classification type"]                    = "\$text = 'F&uuml;ge neue Mitgliederart hinzu';";

#****************************************************************************
#*  Translation text for Member Fields
#****************************************************************************

$trans["Member field, %desc%, has been deleted."] = "\$text = 'Mitgliederfeld, %desc%, wurde gel&ouml;scht.';";
$trans["return to member field list"]             = "\$text = 'Zur&uuml;ck zur Mitgliederfeldliste';";
$trans["return to member fields list"]             = "\$text = 'Zur&uuml;ck zur Mitgliederfeldliste';";
...
$trans["Member field, %desc%, has been added."]   = "\$text = 'Mitgliederfeld, %desc%, wurde hinzugef&uuml;gt.';";
$trans["Add custom member field"]                 = "\$text = 'F&uuml;ge spezifisches Mitgliederfeld hinzu';";
