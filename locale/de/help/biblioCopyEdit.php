...
maximal 20 Zeichen. Dieses Feld ist eine Pflichtangabe, weil es das Exemplar bei der Ausleihe, R&uuml;ckgabe und Vorbestellung identifiziert.
<br>Siehe auch: 
<a href="../shared/help.php?page=barcodes">Barcodes verstehen</a>
  ...
  <tr>
    ...
    <td class="primary" valign="top"><b>Nur beim Bearbeiten &auml;nderbar</b>.
<br>Siehe auch: 
<a href="../shared/help.php?page=status">Status-&Auml;nderungen der Medien verstehen</a>
    </td>
  </tr>
</table>
<br><br>
...
<ul>
  ...
  <li>&Uuml;bermitteln (Autom. Generierung deaktiviert).</li>
</ul>
<br>

<a name="auto">
Wenn man bei einem neues Exemplar die Funktion <input name="autobarco" type="checkbox" checked> Autom. Generierung</a> 
ausw&auml;hlt, versucht Openbiblio automatisch eine neue Nummer zu erstellen, entsprechend den Reglen der internen Nummerierung
<ul>
  <li>Der erste Teil wird dabei aus der <i>Medien-ID</i> errechnet, die das Medium in
Openbiblio intern hat (mit f&uuml;hrenden Nullen). Die Standardl&auml;nge ist 5 Zeichen, das kann ge&auml;ndert werden,
indem man den Wert $nzeros in biblio_copy_new.php &auml;ndert.</li>
  <li>Der letzte Teil wird aus der <i>Exemplar-ID</i> errechnet.</li>
</ul>
<br><br>

<a name="seri">
Das Kopieren von Seriennummern, die in Barcodes integriert sind</a> erleichtert die Eingabe von Exemplaren aus einer einfachen Kartei, wenn keine eindeutigen Nummern vergeben wurden, sondern nur Seriennummern f&uuml;r mehrere Exemplare eines Titels. 
<br>
...
<br>
Wenn man Exemplare hinzuf&uuml;gen m&ouml;chte, die nur eine Seriennummer besitzen geht man folgendermaﬂen vor:
<ul>
  <li>Autom. Generierung einschalten,</li>
  <li>solange neue Kopien anlegen, bis die letzten Stellen des generierten Code mit der Seriennummer &uuml;bereinstimmen,</li>
  <li>l&ouml;schen der permanent nicht verf&uuml;gbaren Exemplare und &Auml;ndern des Status bei den Anderen.</li>
</ul>
<br><br>
