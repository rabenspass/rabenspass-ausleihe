<h1>Barcode-Suche:</h1>
<br><br>
Der Suchen-Link bei der Ausleihe, Rueckgabe und Reservierung oeffnet ein zweites Popup-Fenster, welches mit dem Onlinekatalog(OPAC) fast identisch ist. Im Ergebnisfenster einer Suche hat jedes Exemplar zusaetzliche Links (Ausleihe/Rueckgabe/Reservierung). Wenn man diesen Link auswaehlt schlie�t sich das Fenster und gibt den Barcode zum Hauptfenster zuel;ck, wo dieseuel;bermittelt werden kann.
<br><br>
...
<a name="exam">
Das folgende Beispiel zeigt den link um einen Barcode auszuwaehlen.</a> 
Wenn Ihr Browser die Quickinfo unterstuetzt, dann zeigt Infos an, wenn Sie mit der Maus ueber die links fahren.
<br><br>
  ...
  <tr>
    ...
    <td class="primary" colspan="2" valign="top">
      <table class="primary" width="100%">
        ...
        <td class="primary" nowrap="true"><font class="small"><b><?php echo $loc->getText("biblioSearchCopyStatus"); ?></b>: verfuegbar</font></td>
      </tr>
...
<br>
Dies und noch anderes wird erklaert in der Hilfe zu 
<a href="../shared/help.php?page=biblioCopyEdit">Neues Exemplar und Exemplar bearbeiten</a>.
<br><br>
Beachten Sie, dass die Nummerierung in der linken Spalte, unabhaengig zu Kopiere Serielle Nummern integriert in Barcodes ist.
