...
insert into %prfx%usmarc_block_dm values (3,'Physikalische Beschreibung, Seitenzahlen, Groesse');
insert into %prfx%usmarc_block_dm values (4,'Informationen ueber die Serie');
insert into %prfx%usmarc_block_dm values (5,'Inhaltsangabe, Zusammenfassung, Themenbereich und Anmerkungen');
insert into %prfx%usmarc_block_dm values (6,'Schlagwoerter');
insert into %prfx%usmarc_block_dm values (7,'Zusaetzliche Eintraege, nicht Serien und Themenbezogen');
